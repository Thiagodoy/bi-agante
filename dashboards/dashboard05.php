...
<script type="text/javascript" src="core/loader/loader_dsh05.js"></script> 
<script type="text/javascript" src="core/loader/loader_dsh05_detalhado.js"></script> 
...
<div class="col-md-12" style="height: 40%;"> 
    <p align='center' class="info_detalhado" style="display: block; padding: 50px;">
        Selecione uma linha da tabela acima para exibir os detalhes.
    </p>
    <p align='center' class="carregando_detalhado" style="display: none;">
        <img src='img/gif.gif' width='105' height='115'><br>carregando gráfico...
    </p>
    <div id="DetalhadoColaborador_chart_div"></div>
</div>


<div class="col-md-12" style="display: none;">
    <div id="categoryPicker_Estabelecimento_div_oculto" onclick="AddCss_charts_menu_vertical();"></div>
    <div id="tableChartComparativo_div_oculto" style="padding-right: 10px;display: block;width: 100%;"></div>    
    <div id="tableChartDetalhado_div_oculto" style="padding-right: 10px;display: block;width: 100%;"></div>
    <div id="Detalhado_chart_div_oculto" style="padding-right: 10px;display: block;width: 100%;"></div>
</div>