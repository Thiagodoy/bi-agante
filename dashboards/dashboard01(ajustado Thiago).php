<html>
    <head>
        ...
        <script type="text/javascript" src="core/js/shim.min.js"></script>
        <script type="text/javascript" src="core/js/xlsx.full.min.js"></script> 

        <script type="text/javascript" src="core/js/excellentexport.js"></script> 
        <script type="text/javascript" src="core/js/requirejs.js"></script> 
        <script>
            require(['core/js/excellentexport'], function(ee) {
                window.ExcellentExport = ee;
            });
        </script>
    </head>
    <body>
        <div id="dashboard-01" class="col-md-12">
            <div id="filters" class='filters'>
                <div class=".div-btn-show-hide-filter">
                    <button id="btn-show-hide-filter" onclick="showHideFilter($(this))" data-action="hide" class="btn btpadrao disabled btn-show-hide-filter" title="Ocultar Filtros">
                        <span class="glyphicon glyphicon-eye-close"></span>
                    </button>
                </div>
                <!-- <div class="" id="categoryPicker_Empresa_div" onclick="AddCss_charts_menu_vertical();"></div>
                <div class="" id="categoryPicker_Estabelecimento_div" onclick="AddCss_charts_menu_vertical();"></div>
                <div class="" id="categoryPicker_div" onclick="AddCss_charts_menu_vertical();"></div> -->
            </div>    
            ...
            <!-- <table border="0" style="font-size: 13px;">
                <tr style="vertical-align: top;">
                    <td style="padding-top: 2px;">
                        <button class="btn btpadrao" style="padding-left: 2px; padding-right: 2px;" title="Ocultar Filtros">
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                <a class=""  title="Exportar para xls" download="relatorio.xls" href="#" onclick="exportReport('Detalhado_chart_div');return ExcellentExport.excel(this, 'table-export', 'Relatorio');">
                    <b>XLS</b> <span class="glyphicon glyphicon-share-alt"></span>
                </a>                
        ...
        <div id="container-export" style = 'display:none;'></div>                            
