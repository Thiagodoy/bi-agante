            ...
            <form id='form' name='form' method='POST' action='#' onSubmit="return enviardados();">
                ...
                <div class="form-group col-md-4 col-xs-2" style="padding-top: 28px; padding-left: 3px;">
                    <button type="submit" class="btn btpadrao" id="btfiltrodata" name="btfiltrodata" onclick="ChangeBtAguarde('aguarde_filtrar', 'filtrar');">
                        ...
                        <div id="filtrar">
                            <span class="glyphicon glyphicon-transfer"></span>&nbsp;Comparar
                        </div>
                    </button>
                </div>
            </form>
    ...
    <div class="col-md-6">    
        <div style="height: 65%">  
            <div id="tableChartComparativo_div" style="padding-right: 10px;display: block;width: 100%;">
                <p align='center'>
    ...
    <div class="col-md-6" style="height: 65%;"> 
        <p align='center' class="info_detalhado" style="display: block; padding: 50px;">
            Selecione uma linha da tabela comparativa para exibir os detalhes.
        </p>
    ...
    <div class="col-md-12" style="display: none;">
        ...
        <div id="tableChartComparativo_div_oculto" style="padding-right: 10px;display: block;width: 100%;">
        <div id="tableChartDetalhado_div_oculto" style="padding-right: 10px;display: block;width: 100%;">
        </div>
    </div>