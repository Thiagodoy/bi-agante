...
function drawDashboard() {
     ...
     */
    let filter = filterFactory.build('dashboard05', '#filters-container');
    ...
    function enviaFormGraficoDetalhado(empresa_filtrado, estab_filtrado, state_FilterEmpresa, state_FilterEstabelecimento, state_FilterEvento) {
        ...
        $.ajax({
            type: "POST",
            url: "core/filters/cad_filter_dhs05_detalhado.php", //caminho iniciando da pagina que incluir esse js
            data: dadosForm,
            success: function() {
