...
function drawDashboard() {
     ...
     */
    let filter = filterFactory.build('dashboard08');
    ...
    google.visualization.events.addListener(tableChart, 'ready', function() {
        ...
        if (qtdlinhas_dt > 0) {
            ...
            /*
            dt02.setFormattedValue(0, 1, formatter.formatValue(dt02.getValue(0, 1)));
            dt02.setFormattedValue(1, 1, formatter.formatValue(dt02.getValue(1, 1)));
            dt02.setFormattedValue(2, 1, formatter.formatValue(dt02.getValue(2, 1)));*/
