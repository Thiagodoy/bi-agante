...
function drawDashboard() {
     ...
     */
    let filter = filterFactory.build('dashboard07');
    ...
    var ColumnChart = new google.visualization.ChartWrapper({
        ...
        dataTable: data,
        options: {
            title: 'Evolução Horas Extras por Estabelecimento',
            curveType: 'function',
    ...
    google.visualization.events.addListener(tableChart, 'ready', function() {
        ...
        if (qtdlinhas_dt > 0) {
            ...
            for (var k = indexColunaValores; k < dt02.getNumberOfColumns(); k++) {
